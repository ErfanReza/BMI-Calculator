...
# calculate button(command) function
def calculate_bmi():
# takes input from BMI calculator screen start
...
# Output showing the BMI result, indicating health condition
def bmi_index(bmi):
    if bmi < 18.5:
